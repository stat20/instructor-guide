...
1. Once you are set up with an account, in the terminal, navigate to the directory that contains your slides, for example: `cd summarizing-numerical-data`. In that directory run:

   ```bash
   quarto publish quarto-pub slides.qmd
   ```
   
2. You may be prompted to answer a few questions at the terminal. If it successfully published, it will provide a link to your published document

3. At this point, you're all set!
...
4. Still at the terminal, publish your slides: `quarto publish quarto-pub slides.qmd`. Click through any prompts you might see at the terminal.
